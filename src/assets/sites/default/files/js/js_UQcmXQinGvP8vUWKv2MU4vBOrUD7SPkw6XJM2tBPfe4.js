//More info http://www.cubecamp.ru/articles/share/cubecamp.html
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.article_blog_social_share = {
    attach: function (context, settings) {
	      var selector = '.node--type-daily-reading .social-share';

			$(selector+' a', context).on('click', function() {
				var id = $(this).data('id');
				if(id) {
